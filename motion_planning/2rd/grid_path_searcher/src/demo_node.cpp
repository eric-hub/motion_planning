...
// ros related
ros::Subscriber _map_sub, _pts_sub, _method_set, _tie_set;
...
void rcvSetMethod(const std_msgs::Int8::ConstPtr &msg);
void rcvSetTie(const std_msgs::Int8::ConstPtr &msg);
...
void rcvSetMethod(const std_msgs::Int8::ConstPtr &msg) {
  ...
  _astar_path_finder->setHmethod(m);
}
void rcvSetTie(const std_msgs::Int8::ConstPtr &msg) {
  _astar_path_finder->setTiemethod(msg->data);
}
